...
<BrowserRouter> {/* representa as rotas dos navegadores */}
  < Switch >  {/*quais são as entradas possíveis */}
    <Route path = "/" component = {Home} exact /> {/*a palavra reservada "exact" faz com que nós só consigamos aceder a uma dada página
                                                    única e exclusivamente por uma dada route (Garantia da integridade da rota) */ }
